...
#     '2logD': 'regression',
#     '2logP': 'regression',
#     '2solubility': 'regression',
#     '3CYP1A2I': 'classification',
#     '3CYP2C9I': 'classification',
#     '3CYP2C19I': 'classification',
...
def add_train_args(parser: ArgumentParser):
    ...
    global datasets
    # General arguments
    parser.add_argument("--minimize_score", default=False)
    parser.add_argument("--datasets", default=datasets)
    parser.add_argument("--target_col", default='')
    parser.add_argument("--task_type", default=['classification'])
    parser.add_argument('--earlystop_rounds', default=5)
    parser.add_argument('--class_weights', default=[1.])
    parser.add_argument('--raw_path', default='../data/STL.csv')
    parser.add_argument('--epochs', type=int, default=30,
                        help='Number of epochs to run')    
    parser.add_argument('--split_sizes', type=float, nargs=3, default=[0.6, 0.2, 0.2],
